									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span>رقم الفاتورة</span>
                                                 <span>{{ $print->invoice_number }}</span></p>
											<p class="invoice-info-row"><span>تاريخ الاصدار</span>
                                                 <span>{{ $print->invoice_Date }}</span></p>
											<p class="invoice-info-row"><span>تاؤيخ الاستحقاق</span>
                                                 <span>{{ $print->Due_Date }}</span></p>
											<p class="invoice-info-row"><span>القسم</span> <span>
                                                </span>{{ $print->section->section_name }}</p>
										</div>
									</div>
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												<tr>
													...
													<td class="tx-right">{{ number_format( $print->Amount_comission,2) }}</td>
                                                    @php
                                                        $total = $print->Amount_collection + $print->Amount_comission ;
                                                    @endphp
												...
												<tr>
													<td class="tx-right"> نسبة الضربية ({{ $print->Rate_Vat }})</td>
												...
												<tr>
													<td class="tx-right tx-uppercase tx-bold tx-inverse">الإجمالي شامل الضربية</td>
													<td class="tx-right" colspan="2">
														<h4 class="tx-primary tx-bold">{{ number_format( $print->total,2) }}</h4>
													</td>
												</tr>
											</tbody>
										</table>
