...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفـواتيـر</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/أرشيف الفواتير</span>
						</div>
					</div>
...
@endif
				...
				<div class="row">
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="payment/create" class="model-effect btn btn-primary" style="color:white"><i
                                            class="fas fa-plus"></i>&nbsp; اضافة فاتوة</a>
                        ...
                        <!--/div-->
      {{-- نقل الفاتورة من الارشيف الى قائمة لفواتير    --}}
     <div class="modal fade" id="Transfer_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">إلغاء أرشفة الفاتورة الفاتورة</h5>
            ...
            <div class="modal-body">
                هل انت متأكد من عملية إلغاء الأرشفة ؟
