...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">قـائمة الفواتيــر</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تفاصيل الفاتورة</span>
						</div>
					</div>
											...
											<div class=" tab-menu-heading">
												<div class="tabs-menu1">
													...
													<ul class="nav panel-tabs main-nav-line">
														...
														<li><a href="#tab6" class="nav-link" data-toggle="tab">المرافقات</a></li>
													</ul>
												</div>
											</div>
                                                            ...
                                                            <table class="table table-striped" style="text-align:center">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $details->Amount_comission }}</td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="2">
                                                                                    ...
                                                                                    <a class="btn btn-outline-success btn-sm"
                                                                                        href="{{ url('View_file') }}/{{ $details->invoice_number }}/{{ $attachment->file_name }}"
                                                                                        role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                                        عرض</a>

                                                                                    <a class="btn btn-outline-info btn-sm"
                                                                                        href="{{ url('download') }}/{{ $details->invoice_number }}/{{ $attachment->file_name }}"
                                                                                        role="button"><i
