									...
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
                                                {{ number_format( \App\Models\Payment::sum('total'),2) }}
                                            </h4>
											<p class="mb-0 tx-12 text-white op-7">{{  \App\Models\Payment ::count() }}</p>
										</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
                                                {{ number_format(\App\Models\Payment::where('value_status', 2)->sum('Total'), 2) }}
                                            </h4>
											<p class="mb-0 tx-12 text-white op-7">{{ \App\Models\Payment::where('value_status', 2)->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
                                  % @php
                                    $count_all= \App\Models\Payment::count();
                                    $count_invoices2 = \App\Models\Payment::where('value_status', 2)->count();
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
                                                {{ number_format(\App\Models\Payment::where('value_status', 1)->sum('Total'), 2) }}
                                            </h4>
											<p class="mb-0 tx-12 text-white op-7">{{ \App\Models\Payment::where('value_status', 1)->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">
                                                % @php
                                                $count_all= \App\Models\Payment::count();
                                                $count_invoices1 = \App\Models\Payment::where('value_status', 1)->count();
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
                                                {{ number_format(\App\Models\Payment::where('value_status', 3)->sum('Total'), 2) }}
                                            </h4>
											<p class="mb-0 tx-12 text-white op-7">{{ \App\Models\Payment::where('value_status', 3)->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
                                                % @php
                                    $count_all= \App\Models\Payment::count();
                                    $count_invoices3 = \App\Models\Payment::where('value_status', 3)->count();
